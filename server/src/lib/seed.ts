...
const DEMO_LISTINGS = [
  ...
  },
  {
    ...
    identifiedProduct: 'Grey L-Shape Sectional',
    condition: 'Used',
    quantity: 1,
    priceSources: [
      { retailer: 'wayfair.ca', priceCents: 189900, url: 'https://www.wayfair.ca' },
    ],
  },
  {
    ...
    quantity: 1,
    priceSources: [
      { retailer: 'onepeloton.ca', priceCents: 299500, url: 'https://www.onepeloton.ca' },
    ],
  },
  {
    ...
    identifiedProduct: 'Apple iPhone 13 Pro 256GB',
    condition: 'Like New — 9/10',
    quantity: 1,
    priceSources: [
      { retailer: 'apple.com/ca', priceCents: 139900, url: 'https://www.apple.com/ca' },
      { retailer: 'swappa.com',   priceCents: 69900,  url: 'https://swappa.com' },
    ],
  },
  {
    ...
    identifiedProduct: 'Trek Marlin 5',
    condition: 'Like New — 9/10',
    quantity: 1,
    priceSources: [
      { retailer: 'trekbikes.com', priceCents: 69900, url: 'https://www.trekbikes.com' },
      { retailer: 'mec.ca',        priceCents: 72900, url: 'https://www.mec.ca' },
    ],
  },
  {
    ...
    identifiedProduct: 'Apple MacBook Pro 14" M2',
    condition: 'Like New — 9/10',
    quantity: 1,
    priceSources: [
      { retailer: 'apple.com/ca', priceCents: 249900, url: 'https://www.apple.com/ca' },
      { retailer: 'bestbuy.ca',   priceCents: 249900, url: 'https://www.bestbuy.ca' },
    ],
  },
  {
    ...
    identifiedProduct: 'LG 27UK850-W 4K Monitor',
    condition: 'Like New — 9/10',
    quantity: 1,
    priceSources: [
      { retailer: 'bestbuy.ca', priceCents: 49999, url: 'https://www.bestbuy.ca' },
      { retailer: 'amazon.ca',  priceCents: 47999, url: 'https://www.amazon.ca' },
    ],
  },
];
