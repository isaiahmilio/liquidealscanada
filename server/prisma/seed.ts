...
// Seeds a demo seller and LIVE listings so the browse page has content before any real upload.

const DEMO_LISTINGS = [
  {
    title: 'Apple AirPods (2nd gen)',
    description: 'Open-box, like new. Original packaging included. Seamless pairing with all Apple devices.',
    category: 'Electronics',
    photoPath: 'https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=600&q=80',
    retailPriceCents:    19999,
    suggestedPriceCents: 11999,
    listedPriceCents:    9999,
    costCents:           5000,
  ...
  },
  {
    ...
    description: 'Lightly used, full accessory set included. 7-in-1 multi-use pressure cooker.',
    category: 'Kitchen',
    photoPath: 'https://images.unsplash.com/photo-1585515320310-259814833e62?w=600&q=80',
    retailPriceCents:    13999,
    suggestedPriceCents: 8399,
    listedPriceCents:    6999,
    costCents:           3000,
  ...
  },
  {
    ...
    description: 'Industry-leading noise cancelling. Used twice, in pristine condition with all accessories.',
    category: 'Electronics',
    photoPath: 'https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=600&q=80',
    retailPriceCents:    44999,
    suggestedPriceCents: 29999,
    listedPriceCents:    26999,
    costCents:           15000,
    ...
    priceSources: [
      ...
      { retailer: 'sonystyle.ca', priceCents: 44999, url: 'https://www.sony.ca' },
    ],
  },
  {
    title: 'Nintendo Switch OLED',
    description: 'White edition, barely used. Includes original dock, HDMI, and Joy-Con straps.',
    category: 'Gaming',
    photoPath: 'https://images.unsplash.com/photo-1578303512597-81e6cc155b3e?w=600&q=80',
    retailPriceCents:    44999,
    suggestedPriceCents: 34999,
    listedPriceCents:    32999,
    costCents:           20000,
  ...
  },
  {
    ...
    description: 'Empire Red, used for light baking. Includes flat beater, dough hook, and wire whip.',
    category: 'Kitchen',
    photoPath: 'https://images.unsplash.com/photo-1594385208974-2e75f8d7bb48?w=600&q=80',
    retailPriceCents:    59999,
    suggestedPriceCents: 39999,
    listedPriceCents:    37999,
    costCents:           22000,
  ...
  },
  {
    ...
    description: 'Powerful 40-min runtime. Includes all heads and wall mount. Cleaned and ready to go.',
    category: 'Home',
    photoPath: 'https://images.unsplash.com/photo-1558317374-067fb5f30001?w=600&q=80',
    retailPriceCents:    64999,
    suggestedPriceCents: 44999,
    listedPriceCents:    42999,
    costCents:           28000,
  ...
  },
  {
    ...
    description: 'Black, size 6. Worn once. Buttery-soft nulu fabric, perfect for yoga or lounging.',
    category: 'Clothing',
    photoPath: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=600&q=80',
    retailPriceCents:    14800,
    suggestedPriceCents: 9999,
    listedPriceCents:    8999,
    costCents:           4500,
...
async function main() {
  ...
  for (const item of DEMO_LISTINGS) {
    const exists = await prisma.listing.findFirst({
      where: { sellerId: seller.id, title: item.title },
    });
    if (exists) {
      console.log(`[seed] listing already exists: ${item.title}`);
      continue;
    }
    await prisma.listing.create({
      data: {
        ...
        identifiedProduct:   item.identifiedProduct,
        status:              'LIVE',
  ...
  console.log(`[seed] done — ${created} new listing(s) created.`);
}
